...
Architecture v1.5 规划文档见 [docs/README.md](docs/README.md)。V0–V1.2 已完成 stable IDs/state/proto、Controller 单实例 + Local API/GUI、ControllerKey/DeviceKey、signed enrollment/backup skeleton，以及 signed Site Kit + Host lifecycle/naming；当前进入 V1.3 Direct iroh + Target↔Controller InnerSession E2E，随后接 bounded `Read`。已裁定边界与实施 checklist 见 [docs/06-gaps.md](docs/06-gaps.md)。
