...
Architecture v1.5 规划文档见 [docs/README.md](docs/README.md)。V0–V1.3 已完成 stable IDs/state/proto、Controller 单实例 + Local API/GUI、ControllerKey/DeviceKey、signed enrollment/backup、signed Site Kit + Host lifecycle/naming，以及 iroh direct/public-relay + Target↔Controller Noise InnerSession E2E；当前进入 V1.4 bounded `Read` + V1 最小 control plane。已裁定边界与实施 checklist 见 [docs/06-gaps.md](docs/06-gaps.md)。
